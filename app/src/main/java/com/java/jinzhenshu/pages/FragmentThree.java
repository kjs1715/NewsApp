...
public class FragmentThree extends BaseFragment{
    ...
    private void getSqdate(){
        showDatas.clear();
        List<News> sqDatas=DaoUntils.queryByType(3);
        if (sqDatas.size()!=0){
    ...
    private void getData(){
        ...
        String urlString = "http://tech.qq.com/web/rss_web.xml";
        ...
        parser.onFinish(new Parser.OnTaskCompleted() {
            ...
            public void onTaskCompleted(List<News> list) {
                ...
                if (DaoUntils.queryByType(1).size()==0){
                    ...
                    List<News> sqDatas=DaoUntils.queryByType(1);
                    for (int i=0;i<5;i++){
                        showDatas.add(sqDatas.get(i));
                    }
                    adapter.setDatas(showDatas);
        ...
        dialog= new AlertDialog.Builder(getContext()).setMessage("你确定删除吗？")
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        adapter.setDatas(DaoUntils.queryByType(3));
                    }
